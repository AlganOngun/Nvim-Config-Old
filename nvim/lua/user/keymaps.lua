...
keymap('n', '<c-f>', ':%!astyle --mode=c --style=allman --indent-namespaces --indent-preproc-block --align-reference=type --align-pointer=type --pad-method-colon=all --remove-comment-prefix --attach-return-type --break-closing-braces --unpad-paren --pad-comma --pad-oper --indent-col1-comments --indent-switches --indent-classes<cr><cr>', options)
